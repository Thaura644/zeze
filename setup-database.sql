...
SELECT
    ...
    COUNT(DISTINCT ps.user_id) FILTER (WHERE ps.start_time > NOW() - INTERVAL '7 days') as sessions_last_7_days,
...
-- RLS Policies (simplified for basic functionality)
